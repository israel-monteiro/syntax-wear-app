...
const productsInCart = [
    ...
    { id: 5, name: "Produto 5", image: MensWoolCruiserWaterproof, price: 15, quantity: 2 }, { id: 1, name: "Produto 1", image: MensTreeDasher, price: 35, quantity: 5 },
    { id: 2, name: "Produto 2", image: MensTreeRunnerNz, price: 75, quantity: 2 },
    { id: 3, name: "Produto 3", image: MensWoolCruiser, price: 85, quantity: 4 },
    { id: 4, name: "Produto 4", image: MensWoolCruiserSlipOn, price: 135, quantity: 6 },
...
export const ShoppingCart = () => {
    ...
    return (
        <>
            ...
            {/* Overlay */}
            <div
                className={`${cartIsOpen ? "bg-black/70 visible" : 
                    "bg-transparent invisible"} fixed top-0 bottom-0 left-0 right-0`}
            ...
            >
                ...
                >
                    ...
                    <ul className="p-4 overflow-y-auto scrollbar-hide 
